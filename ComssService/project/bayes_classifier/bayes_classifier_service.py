...
class MultiplierService(SyncService):
    ...
    def run(self):
        ...
        while True:  # będzie się wykonywać tak długo, jak będzie działać usługa
            ...
            # wez 2 poprzednie (http + length) odczyty i dołącz obecne
            ...
            self.send('3', str(int((1 - probability)*100)))  # na wyjście o id '2' wyślij wyliczone prawdopodobieństwo

...
class MultiplierService(SyncService):
    ...
    def __init__(self):
        self.mi = matrix.matrix([257.3289, 1891.4641, 257.3412, 1891.4578, 257.3534, 1891.0688]).transpose()
        self.cov = matrix.matrix([[2735.1732, -105164.6553, 1394.3363, -49252.3400, 1444.7696, -55889.5886],
                                  ...
                                  [-55889.5886, 5355152.3607, -49253.1383, 9576954.0862, -105188.1871, 804017269.7513]]).transpose()
